package com.bigsonata.swarm.common.whisper.disruptor;

import com.bigsonata.swarm.common.whisper.*;
...
public class DisruptorBroker<T> extends Broker<T> {
  ...
  @Override
  public void produceAsync(String topic, T message, Callback callback) throws Exception {
    produce(topic, message);
    if (callback != null) {
      callback.handle(Result.success());
    }
  }
